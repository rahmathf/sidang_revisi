...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h5 class="m-0 font-weight-bold text-primary">Ubah Data Akun</h5>
        </div>
        <div class="card-body">
            <form class="#" action="/User/update/<?= $auth['id']; ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <!-- <input type="hidden" name="passwordLama" value="<?= $auth['password']; ?>"> -->
                <input type="hidden" name="sampulLama" value="<?= $auth['sampul']; ?>">
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-user" name="username" placeholder="Username" value="<?= (old('username')) ? old('username') : $auth['username'] ?>">
                        <div class="invalid-feedback">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control form-control-user" name="saldo" placeholder="Saldo" value="<?= (old('saldo')) ? old('saldo') : $auth['saldo'] ?>">
                        <div class="invalid-feedback">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <img src="/img/<?= $auth['sampul']; ?>" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-6">
